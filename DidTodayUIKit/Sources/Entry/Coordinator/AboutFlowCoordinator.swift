...
final class AboutFlowCoordinator: Coordinator {
    ...
    private func showAbout() {
        let router = AboutRouter(showActivityToRecommend: showActivityToRecommend, openAppStoreToReview: openAppStoreToWriteAReview, showPrivacyPolicy: showPrivacyPolicy)
